...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.menuDock = QtGui.QMenu(self.menubar)
        self.menuDock.setObjectName(_fromUtf8("menuDock"))
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/image/undo_128px_1175681_easyicon.net.ico")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionUndo.setIcon(icon)
        self.actionUndo.setObjectName(_fromUtf8("actionUndo"))
        self.actionRedo = QtGui.QAction(MainWindow)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/image/redo_128px_1175650_easyicon.net.ico")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRedo.setIcon(icon1)
        self.actionRedo.setObjectName(_fromUtf8("actionRedo"))
        self.act_add_leftPanel = QtGui.QAction(MainWindow)
        self.act_add_leftPanel.setObjectName(_fromUtf8("act_add_leftPanel"))
        self.act_add_bottomPanel = QtGui.QAction(MainWindow)
        self.act_add_bottomPanel.setObjectName(_fromUtf8("act_add_bottomPanel"))
        self.act_add_rightPanel = QtGui.QAction(MainWindow)
        self.act_add_rightPanel.setObjectName(_fromUtf8("act_add_rightPanel"))
        ...
        self.menuDock.addAction(self.act_add_leftPanel)
        self.menuDock.addAction(self.act_add_bottomPanel)
        self.menuDock.addAction(self.act_add_rightPanel)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.menuDock.setTitle(_translate("MainWindow", "dock", None))
        ...
        self.act_add_leftPanel.setText(_translate("MainWindow", "添加左侧dock", None))
        self.act_add_bottomPanel.setText(_translate("MainWindow", "添加下部dock", None))
        self.act_add_rightPanel.setText(_translate("MainWindow", "添加右边dock", None))
