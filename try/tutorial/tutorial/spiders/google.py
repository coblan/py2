...
urls = []
with open(u'd:/try/google.html','rb') as f:
    urls= json.load(f)
    ...
    # for a in soup.select('h3 a'):
        # urls.append( a['href'] )
    # for a in soup.select('#navcnt a'):
        # urls.append( "https://www.google.com"+a['href'] )

class CusGpSearch(CrawlSpider):
    name='google_email'
    ...
    rules=(
        ...
        Rule(LinkExtractor(deny_domains=('google.com')),callback='parse_item',follow=True)
