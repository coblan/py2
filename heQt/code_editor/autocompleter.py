...
class Autocompleter(QListView):
    ...
    def autoComplet(self):
        ...
        text = self.lastText_crtLine(pos)
        out = []
        while True:
    ...
    def showWithPos(self,pos):
        ...
        self.move(x,  y + self.editor.lineHeight())
        self.scrollTo(self.currentIndex(), QListView.PositionAtTop)
        self.show()   
