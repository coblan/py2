...
from heQt.scintilla.bridge import Bridge
from heQt.scintilla import const
from heQt.scintilla.lineManager import LineManager
from heQt.scintilla.autocompleter import *
from heQt.scintilla.cusLexer import CusLexer
...
class Scintilla(Bridge):
    ...
    def setup001(self,mainWin=None):
        ...
        from heQt.scintilla.exraHight import DbFind
